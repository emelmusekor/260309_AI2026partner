...
def build_chapter_20():
    with open("d:/AIED2.0_docs/webbook/chapter-1.html", "r", encoding="utf-8") as f:
    ...
    with open("d:/AIED2.0_docs/webbook/chapter-20.html", "w", encoding="utf-8") as f:
        f.write(str(soup))
...
build_chapter_20()
for file in glob.glob("d:/AIED2.0_docs/webbook/chapter-*.html"):

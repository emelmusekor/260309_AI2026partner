...
def create_global_assets():
    sample_file = "d:/AIED2.0_docs/webbook/chapter-1.html"
...
"""
    ...
    with open("d:/AIED2.0_docs/webbook/widgets.css", "w", encoding="utf-8") as f:
        f.write(refined_css)
        
    with open("d:/AIED2.0_docs/webbook/widgets.js", "w", encoding="utf-8") as f:
        f.write(refined_js)
